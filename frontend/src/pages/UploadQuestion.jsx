  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (err.response?.status === 409) {
        ...
        setDuplicateModal({
          question: data.existing_question,
      ...
      <div style={{ marginBottom: "15px" }}>
        ...
        <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
          <select
            value={selectedUniversity}
            onChange={(e) => handleUniversityChange(e.target.value)}
            style={{ flex: "1 1 200px", padding: "8px", borderRadius: "4px", border: "1px solid #ddd", minWidth: "150px" }}
          >
            <option value="">Select University</option>
            {universities.map((u) => (
              <option key={u} value={u}>
          ...
          <button
            ...
            style={{ padding: "8px 16px", cursor: "pointer", minWidth: "60px" }}
          >
            Add
          </button>
        </div>
      ...
      {duplicateModal && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ color: "#dc3545", marginTop: 0 }}>⚠️ Duplicate Question Found</h3>
            <p>{duplicateModal.message}</p>
            <div style={{ marginTop: "15px" }}>
              <h4 style={{ marginBottom: "10px" }}>Existing Question Details:</h4>
              <ul style={{ listStyle: "none", padding: 0 }}>
                <li style={{ padding: "5px 0", borderBottom: "1px solid #eee" }}>
                  <strong>University:</strong> {duplicateModal.question.university}
                </li>
                <li style={{ padding: "5px 0", borderBottom: "1px solid #eee" }}>
                  <strong>Subject:</strong> {duplicateModal.question.subject}
                </li>
                <li style={{ padding: "5px 0", borderBottom: "1px solid #eee" }}>
                  <strong>Course:</strong> {duplicateModal.question.course}
                </li>
                <li style={{ padding: "5px 0", borderBottom: "1px solid #eee" }}>
                  <strong>Year:</strong> {duplicateModal.question.year}
                </li>
                <li style={{ padding: "5px 0", borderBottom: "1px solid #eee" }}>
                  <strong>Semester:</strong> {duplicateModal.question.semester}
                </li>
                <li style={{ padding: "5px 0", borderBottom: "1px solid #eee" }}>
                  <strong>Exam Type:</strong> {duplicateModal.question.exam_type}
                </li>
                <li style={{ padding: "5px 0", borderBottom: "1px solid #eee" }}>
                  <strong>Status:</strong> {duplicateModal.question.status}
                </li>
                <li style={{ padding: "5px 0" }}>
                  <strong>Uploaded:</strong> {new Date(duplicateModal.question.uploaded_at).toLocaleString()}
                </li>
              </ul>
            </div>
            <button
