...
// const QuestionGrid = ({ questions, purchase, API_BASE }) => {
...
//           marginBottom: "20px"
//         }}>
//           <h3>📚 {purchase.subject?.toUpperCase()} - {purchase.exam_type?.toUpperCase()}</h3>
//           <p><strong>University:</strong> {purchase.university}</p>
//           <p><strong>Year:</strong> {purchase.year} | <strong>Semester:</strong> {purchase.semester}</p>
//           <p><strong>Total Questions:</strong> {purchase.total_questions}</p>
//           <p><strong>Valid Until:</strong> {new Date(purchase.expiry_date).toLocaleDateString()}</p>
//           <p><strong>Time Remaining:</strong> {Math.ceil(purchase.time_remaining)} days</p>
//         </div>
//       )}
...
//                 <div key={image.id || imgIndex} style={{ marginBottom: "10px" }}>
//                   <img
...
//                       fallback.style.cssText = "padding: 20px; background: #f8f9fa; border-radius: 4px; text-align: center; color: #666;";
//                       fallback.innerHTML = `
//                         <p>⚠️ Image not available</p>
//                         <p style="font-size: 12px;">${image.file_name || 'Unknown file'}</p>
//                       `;
...
//     // Only require university and subject
//     if (!university || !subject) {
...
//   const isSearchDisabled = !filters.university ||
//     !filters.subject ||
//     loading;
...
//       }}>
//         <div>
//           <strong>💰 Coin Balance:</strong> {userCoins} coins
//         </div>
//         <div>
//           <button
...
//                   {purchase.is_active === "active" && purchase.time_remaining && (
//                     <div style={{
//                       marginTop: "10px",
//                       padding: "8px",
//                       backgroundColor: "#e3f2fd",
...
//                       fontSize: "14px"
//                     }}>
//                       <strong>⏰ Valid for:</strong> {Math.ceil(purchase.time_remaining)} days remaining
//                     </div>
//                   )}
